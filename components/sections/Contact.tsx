...
export default function Contact() {
    ...
    const onSubmit = async (data: ContactFormValues) => {
        setSending(true);
        try {
            const response = await fetch("https://formspree.io/f/mqevjpgn", {
                method: "POST",
                headers: {
            ...
            if (response.ok) {
                ...
                console.error("Formspree server error:", result);
                if (result.errors && result.errors.length > 0) {
                    toast.error(result.errors[0].message);
                } else {
                    toast.error("Formspree error: Check your Formspree dashboard settings.");
                }
            }
        } catch (err) {
                    ...
                    >
                        <div>
                            ...
                            <p className="text-muted-foreground text-base leading-relaxed max-w-md">
                                Whether you have a specific opportunity in mind, a freelance project, or just want to discuss web architectures, my gateway is open.
                            </p>
                        </div>

                        <div className="space-y-4">
                            <a href="mailto:suradaramesh4@gmail.com" className="flex items-center gap-4 group">
                                ...
                                <div>
                                    ...
                                    <p className="text-foreground text-sm font-bold font-mono group-hover:text-amber-500 transition-colors">suradaramesh4@gmail.com</p>
                                </div>
                            </a>

                            <a href="https://www.linkedin.com/in/rameshsurada/" target="_blank" className="flex items-center gap-4 group">
                                <div className="w-10 h-10 rounded border border-border bg-background flex items-center justify-center group-hover:border-amber-500/30 group-hover:bg-amber-500/5 transition-all duration-300">
                                ...
                                <div>
                                    ...
                                    <p className="text-foreground text-sm font-bold font-mono group-hover:text-amber-500 transition-colors">linkedin.com/in/rameshsurada</p>
                                </div>
                            </a>
                        </div>
                        ...
                        <div className="flex gap-3">
                            {[
                                { icon: FaGithub, href: "https://github.com/rameshsurada" },
                                { icon: FaLinkedin, href: "https://www.linkedin.com/in/rameshsurada/" },
                                { icon: Mail, href: "mailto:suradaramesh4@gmail.com" }
                            ].map((social, i) => (
